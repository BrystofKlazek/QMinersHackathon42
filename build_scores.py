...
if __name__ == "__main__":
    all_path = "data/cleaned_games_all.csv"
    games_all = pd.read_csv(all_path)

    features_all = build_features(games_all)
    
    features_all.to_csv("data/features_many.csv", index=True)
